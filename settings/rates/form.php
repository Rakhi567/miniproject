...
<form action='' method='POST' class="form-horizontal"> 
    ...
    <div class="control-group">
        <label class="control-label" for="rate"> Rate (Per KG)</label >
        <div class="controls">
            <input class="input-xlarge" type="number" placeholder="4**" name='rate' id='r_kg' max="99999"value='<?php echo stripslashes($row['rate']) ?>'/> 
    </div>
