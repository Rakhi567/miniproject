    ...
    <table class="table table-hover table-striped table-condensed table-bordered"> 
        ...
        <tbody> 
            ...
            if (isset($_REQUEST['farmer']) && $_REQUEST['farmer'] != '') {
                ...
                echo "<tr><td><strong>Total:$total </strong></td><td><strong>--</strong><td>--</td></tr>";
            }
            ?> 
        </tbody>         
    </table>     
...
<Body style="background-repeat: no-repeat; background-size: cover; border-bottom-color: #000000; background-image: url('../img/2095777.jpg');">
</Body>