...
<table class="table table-hover table-striped table-condensed table-bordered"> 
    ...
    while ($farmer = mysqli_fetch_array($farmers)) {
        ...
        echo "<tr class='success'><td><strong>Total</strong></td><td><strong>All</strong><td>$total Kgs</td></tr>";
    }
    ?> 
    </tbody>     
</table> 
...
<Body style="background-repeat: no-repeat; background-size: cover; border-bottom-color: #000000; background-image: url('../img/er.jpg');">
</Body>