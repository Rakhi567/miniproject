...
?> 
<html>
    <Body style="background-repeat: no-repeat; background-size: cover; border-bottom-color: #000000; background-image: url('../img/slide1.jpg'); background-position: center center;">
...
$result = mysqli_query($conn,"SELECT * FROM `delivery` WHERE r_f_no=$f_no and r_dt BETWEEN '$start' and '$end'") or trigger_error(mysqli_error($conn));
                $farmer_total = 0;
            ...
            echo "<tr class='success'><td><strong>Total</strong></td><td><strong>All</strong><td>$total Kgs</td><td>---</td></tr>";
        }
