...
<form action='' method='POST' class="form-horizontal" name="delivery">
    <div class="control-group"> 
        ...
        <div class="controls"> 
            <input id="f_no" class="input-xlarge" type="number" placeholder="CCF****" name='r_f_no' value='<?php echo isset($row)?stripslashes($row['r_f_no']):''; ?>'/> 
    ...
    <div class="control-group"> 
        ...
        <div class="controls"> 
            <input class="input-xlarge" type="number" max="9999" placeholder="4**" name='r_kg' value='<?php echo isset($row)?stripslashes($row['r_kg']):''; ?>'/> 
    ...
    <div class="control-group"> 
        ...
        <div class="controls"> 
            <input class="input-xlarge" type="text" placeholder="Deliverer-X.." name='r_deliverer' pattern="[A-Z a-z]{1,32}" value='<?php echo isset($row)?stripslashes($row['r_deliverer']):'' ?>'/> 
        </div>         
    </div>     
    <div class="control-group"> 
        <div class="controls"> 
